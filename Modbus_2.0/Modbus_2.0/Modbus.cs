...
namespace Modbus_2
{
    ...
    class Master
    {
        ...
        //--------------------------------------------------------------------------
        /// <summary>Shows IP of client</summary>
        public string IP
        {
            get { return _IP; }
        ...
        /// <param name="numInputs">Length of data.</param>
        /// <param name="values">Contains the result of function.</param>
        public void ReadInputRegister(ushort id, byte unit, ushort startAddress, UInt32 numInputs, ref byte[] values)
        {
        ...
        private byte[] CreateReadHeader(ushort id, byte unit, ushort startAddress, UInt32 length, byte function)
        {
